...
DOCUMENTATION = '''
    ...
    notes:
        ...
        - It may be useful to create a shell script to call with C(cgexec) containing your C(ansible-playbook) command and any environment variables
          that you may need to execute. Using an C(ansible.cfg) file may alleviate the need to export environment variables for this callback.
          e.g. C(cgexec -g memory:ansible_profile ./profile.sh)
    options:
      max_mem_file:
        required: True
